...
actuator_list: list[Actuator] = [
    # Right arm (nn_id 0-4)
    Actuator(actuator_id=21, nn_id=0, kp=100.0, kd=4.0, max_torque=MAX_TORQUE["03"], joint_name="dof_right_shoulder_pitch_03"),
    Actuator(actuator_id=22, nn_id=1, kp=100.0, kd=4.0, max_torque=MAX_TORQUE["03"], joint_name="dof_right_shoulder_roll_03"),
    Actuator(actuator_id=23, nn_id=2, kp=40.0, kd=2.0, max_torque=MAX_TORQUE["02"], joint_name="dof_right_shoulder_yaw_02"),
    ...
    # Left arm (nn_id 5-9)
    Actuator(actuator_id=11, nn_id=5, kp=100.0, kd=4.0, max_torque=MAX_TORQUE["03"], joint_name="dof_left_shoulder_pitch_03"),
    Actuator(actuator_id=12, nn_id=6, kp=100.0, kd=4.0, max_torque=MAX_TORQUE["03"], joint_name="dof_left_shoulder_roll_03"),
    Actuator(actuator_id=13, nn_id=7, kp=40.0, kd=2.0, max_torque=MAX_TORQUE["02"], joint_name="dof_left_shoulder_yaw_02"),
    ...
    Actuator(actuator_id=41, nn_id=10, kp=150.0, kd=8.0, max_torque=MAX_TORQUE["04"], joint_name="dof_right_hip_pitch_04"),
    Actuator(actuator_id=42, nn_id=11, kp=200.0, kd=8.0, max_torque=MAX_TORQUE["03"], joint_name="dof_right_hip_roll_03"),
    Actuator(actuator_id=43, nn_id=12, kp=100.0, kd=4.0, max_torque=MAX_TORQUE["03"], joint_name="dof_right_hip_yaw_03"),
    ...
    Actuator(actuator_id=31, nn_id=15, kp=150.0, kd=8.0, max_torque=MAX_TORQUE["04"], joint_name="dof_left_hip_pitch_04"),
    Actuator(actuator_id=32, nn_id=16, kp=200.0, kd=8.0, max_torque=MAX_TORQUE["03"], joint_name="dof_left_hip_roll_03"),
